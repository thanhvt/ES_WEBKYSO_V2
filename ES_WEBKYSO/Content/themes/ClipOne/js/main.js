...
var Main = function () {
    ...
    window.icheckInit = runCustomCheck;
    ...
    //function to active node (ninhvq)
    var runActiveNode = function () {
        var li = $(".main-navigation-menu").find("li").find(".active.open");
        while (li.parent().closest("li").length > 0) {
            li.parent().closest("li").addClass("active open");
            li = li.parent().closest("li");
        }
    };
    //funtion close alert (ninhvq)
    ...
    //funciton remove node (ninhvq)
    var runRemoveNode = function () {
        var li = $(".main-navigation-menu").find("li").has('a[href=""]');
        li.remove();
    }
