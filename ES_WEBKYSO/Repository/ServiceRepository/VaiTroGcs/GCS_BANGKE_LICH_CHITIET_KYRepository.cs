...
{
    public class GCS_BANGKE_LICH_CHITIET_KYRepository<T> : BaseRepository<GCS_BANGKE_LICH_CHITIET_KY>
    {
        public GCS_BANGKE_LICH_CHITIET_KYRepository(DbContext context, UnitOfWork repo) : base(context, repo)
        {

        }
        public List<GCS_BANGKE_LICH_CHITIET_KY> ManagerGetAllForIndex(int ID_LICHGCS, string orderKey, ref Paging page)
        {
            ...
            var ret = GetAll(o =>
                   ...
                   , "ID", ref page)
               .ToList()
               .Select(x => new GCS_BANGKE_LICH_CHITIET_KY
               {
                   ID = x.ID,
