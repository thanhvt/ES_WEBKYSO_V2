...
{
    public class SOGCS_NVIENRepository<T> : BaseRepository<SOGCS_NVIEN>
    {
        public SOGCS_NVIENRepository(DbContext context, GenericRepository repo) : base(context, repo)
        {
        }
        public override List<SOGCS_NVIEN> GETALL()
        {
            try
            {
        ...
        public override List<SOGCS_NVIEN> ManagerGetAllForIndex(FindModelGcs findModel, string orderKey, ref Paging page)
        {
        ...
        public override List<SOGCS_NVIEN> ManagerGetAllForIndex(string orderKey, ref Paging page)
        {
            if (orderKey.EndsWith("String"))
            {
                orderKey = orderKey.Replace("String", "");
