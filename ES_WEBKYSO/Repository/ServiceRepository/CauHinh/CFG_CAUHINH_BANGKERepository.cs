...
{
    public class CFG_CAUHINH_BANGKERepository<T> : BaseRepository<CFG_BANGKE_DONVI>
    {
        public CFG_CAUHINH_BANGKERepository(DbContext context, UnitOfWork repo) : base(context, repo)
        {
        }
