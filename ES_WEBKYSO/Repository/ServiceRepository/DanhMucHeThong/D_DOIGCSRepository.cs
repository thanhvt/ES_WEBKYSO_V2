...
{
    public class D_DOIGCSRepository<T> : BaseRepository<D_DOIGCS>
    {
        public D_DOIGCSRepository(DbContext context, UnitOfWork repo) : base(context, repo)
        {

        }

        public override List<D_DOIGCS> ManagerGetAllForIndex(FindModelGcs findModel, string orderKey, ref Paging page)
        {
