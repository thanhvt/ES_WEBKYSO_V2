...
{
    public sealed class GenericRepository : IDisposable
    {
        private readonly DataContext.DataContext _context = new DataContext.DataContext();
        ...
        public BaseRepository<T> RepoBase<T>() where T : class
        {
            ...
            constructorMethod = makeMeNow.GetConstructor(new[] { typeof(DbContext), typeof(GenericRepository) });
